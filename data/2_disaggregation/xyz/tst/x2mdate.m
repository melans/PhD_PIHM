...
% X2MDATE provides a simple method to convert between excel dates and
% MATLAB dates.  
%
% USAGE:
...
%   TYPE      - [OPTIONAL] A scalar or vector of the same size as XLSDATE that
%               describes the Excel basedate.  Can be either 0 or 1.  If 0 (default),
%               the base date of Dec-31-1899 is used.  If 1, the base date is Jan 1,
%               1904.
%
% OUTPUTS:
...
%
% COMMENTS:
%   This is a reverse engineered clone of the MATLAB function x2mdate and should 
%   behave the same. You only need it if you do not have hte financial
%   toolbox installed.
