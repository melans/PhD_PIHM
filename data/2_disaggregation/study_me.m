...
longitude_start = -98.8125;
latitude_start = 29.3125;
longitude_end = -97.3125;
latitude_end = 30.3125;
...
for i = 1:length(latitude_series)
    for j = 1:length(longitude_series)
        ...
        filename = strcat('data/observed_daily/','data_',num2str(lat_temp),'_',num2str(long_temp)); % on unix and windows,\ or / is different
        ...
        if (judge == -1)
           % do nothing
            ...
            filename = strcat('data/forecast_monthly/','data_',num2str(lat_temp),'_',num2str(long_temp)); % on unix and windows,\ or / is different
            ...
            filename_out_prcp = strcat('data/forecast_daily/','data_',num2str(lat_temp),'_', num2str(long_temp));
